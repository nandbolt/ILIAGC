...
draw_text_transformed(_x + 16, _y + 4, ":", _s, _s, 0);
if (os_type == os_android || !firstPlayerUsingKeyboard()) draw_sprite(sButtonA, 0, _x + 20, _y + 4);
...
draw_text_transformed(_x + 16, _y + 4, ":", _s, _s, 0);
if (os_type == os_android || !firstPlayerUsingKeyboard()) draw_sprite(sButtonDPadDown, 0, _x + 20, _y + 4);
else draw_sprite(sKeyS, 0, _x + 20, _y + 4);
_y += _yoff;
